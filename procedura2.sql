...
EXEC add_new_department @p_department_name = 'Cybersecurity Response', @p_menager_id = 105;
...
EXEC add_new_department @p_department_name = 'User Experience Design', @p_menager_id =  110, @p_location_id = 3000;
